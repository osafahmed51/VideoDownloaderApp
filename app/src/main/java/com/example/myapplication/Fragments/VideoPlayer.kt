...
class VideoPlayer : Fragment(com.example.myapplication.R.layout.fragment_video_player) {
    ...
    fun setImageView()
    {
        ...
        binding.simpleVideoView.visibility = View.GONE
        val imageBitmap = BitmapFactory.decodeFile(videoinfofilepath)
        binding.simpleImageView.setImageBitmap(imageBitmap)
    }
