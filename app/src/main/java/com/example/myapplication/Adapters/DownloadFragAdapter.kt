...
class DownloadFragAdapter(private val dlist : List<VideoInfo>,private var context: Context,private val downfragclicklistener : DownloadFragItemClickListener) : RecyclerView.Adapter<DownloadFragAdapter.ViewHolderDownload>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderDownload {
        ...
        return DownloadFragAdapter.ViewHolderDownload(view)
    }
