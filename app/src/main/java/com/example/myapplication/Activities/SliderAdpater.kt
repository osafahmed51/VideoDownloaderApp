...
class SliderAdpater(val imagelist:ArrayList<Sliderdata>) : SliderViewAdapter<SliderAdpater.SliderAdapterVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?): SliderAdpater.SliderAdapterVH {
    ...
    override fun onBindViewHolder(viewHolder: SliderAdpater.SliderAdapterVH?, position: Int) {
